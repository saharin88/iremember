...
class LocationPeopleController extends Controller
{
    ...
    #[Endpoint(title: 'List people by location', description: 'Get a list of people by location')]
    #[UrlParam(name: 'location', type: 'integer', description: 'Location ID', required: true, example: 1)]
    #[UrlParam(name: 'relation', type: 'string', description: 'Relation', required: true, example: 'birth', enum: ['birth', 'death', 'burial', 'wound'])]
